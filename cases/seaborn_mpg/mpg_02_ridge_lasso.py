...
# Drop 6 rows where horsepower is missing; drop name (too high cardinality)
...
print(f"\nOLS  train RMSE = {root_mean_squared_error(y_train, _unscale_y(ols.predict(X_train_s))):.3f} mpg")
...
print(f"\nRidge coarse  best α={best_ridge_c:.3f}  val RMSE={min(ridge_val_c) * y_std:.3f} mpg")
